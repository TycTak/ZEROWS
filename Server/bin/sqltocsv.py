...
def is_insert(line, table):
    """
    Returns true if the line begins a SQL insert statement.
    """
    return line.startswith('INSERT INTO `' + table + '`') or False
...
def main():
    ...
    file = cm.getArgValue(sys.argv, '-f', '')
    table = cm.getArgValue(sys.argv, '-t', '')
